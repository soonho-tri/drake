...
dreal_repository = repository_rule(
    ...
    attrs = {
        ...
        "filenames": attr.string_list(
            default = [
                "dreal/dreal/dreal_{}_amd64.deb".format(DREAL_VERSION),
                "dreal/ibex/libibex-dev_{}.20181130120337.git65fc3b6c28ea49cb2da7e9b693add6ba7c5fc4ae~16.04_amd64.deb".format(IBEX_VERSION),  # noqa
            ],
        ),
