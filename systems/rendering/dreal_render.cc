...
int main() {
  ...
  Environment env{{sx, 0.5},  {sy, 0.5}, {px, 0.0}, {py, 0.0},
                  {pz, -3.0}, {lx, 0.0}, {ly, 0.0}, {lz, 0.0},
  ...
  if (result) {
    ...
    std::cout << "v0x.mid(): " << v0xi.mid() << ", v0x.diam():" << v0xi.diam()
              << std::endl;
    std::cout << "v0y.mid(): " << v0yi.mid() << ", v0y.diam():" << v0yi.diam()
              << std::endl;
    std::cout << "v0z.mid(): " << v0zi.mid() << ", v0z.diam():" << v0zi.diam()
              << std::endl;
    std::cout << "v1x.mid(): " << v1xi.mid() << ", v1x.diam():" << v1xi.diam()
              << std::endl;
    std::cout << "v1y.mid(): " << v1yi.mid() << ", v1y.diam():" << v1yi.diam()
              << std::endl;
    std::cout << "v1z.mid(): " << v1zi.mid() << ", v1z.diam():" << v1zi.diam()
              << std::endl;
    std::cout << "v2x.mid(): " << v2xi.mid() << ", v2x.diam():" << v2xi.diam()
              << std::endl;
    std::cout << "v2y.mid(): " << v2yi.mid() << ", v2y.diam():" << v2yi.diam()
              << std::endl;
    std::cout << "v2z.mid(): " << v2zi.mid() << ", v2z.diam():" << v2zi.diam()
              << std::endl;
  } else {
